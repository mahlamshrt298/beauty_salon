...
urlpatterns = [
    # صفحه اصلی پنل یا داشبورد
    path('', views.dashboard, name='dashboard'),

    # مدیریت نوبت‌ها
    path('bookings/', views.booking_list, name='booking_list'),
    # تغییر وضعیت نوبت‌ها (تایید، لغو، تکمیل شده، عدم حضور مشتری)
    ...
    #برای گرفتن لیست پرسنل وقتی کاربر تو فرم یه خدمت رو انتخاب می‌کنه
    #توی booking_update ازش استفاده شده ، ajax هست
    path('get-staff/', views.get_staff_by_service, name='get_staff_by_service'),
    ...
    #توی اضافه یا ویرایش خدمت ازش استفاده شده
    ...
    # صفحه خطای عدم دسترسی (وقتی کاربر سطح دسترسی لازم رو نداره)
    ...
    #برنامه کاری پرسنل
    path('staff/plan/', views.staff_plan, name='staff_plan'),
